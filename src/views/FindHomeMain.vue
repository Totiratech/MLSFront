                ...
                <form class="row row-cols-lg-auto g-3 align-items-center">
                  ...
                  <div class="col-md-6 col-6">
                    <div class="form-check">
                      <input class="form-check-input property-status" value="Sale" checked name="search_type"
                        type="radio" />
                    ...
                    <div class="form-check">
                      <input class="form-check-input property-status" value="Lease" name="search_type" type="radio" />
                      <label class="form-check-label" for="inlineFormCheck">
                        Rent
                      </label>
                    </div>
                  ...
                  <div class="col-md-6 col-6">
                    <select class="form-select mt-2" aria-label="Default select example" id="area">
                      <option value="" selected class="capitalize">location</option>
                      <option v-for="area in this.areas" :value="area.Area_num" class="capitalize">{{ area.Area }}
                      </option>
                    </select>
                  </div>
                  <div class="col-md-6 col-6">
                  ...
                  <div class="col-md-6 col-6 mt-auto">
                    <button class="moreFeatures btn btn-secondary text-start w-100" type="button"
          ...
          <div class="container">
            ...
            <div class="col-12 mt-3">
              <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center" id="pagination-holder">
